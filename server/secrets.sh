...
keys=("MONGO_CLUSTER" "MONGO_DB_NAME" "MONGO_USER" "MONGO_PASSWORD" "AUTH_KEY" "PAYPAL_CLIENT_ID" "PAYPAL_CLIENT_SECRET" "PAYPAL_ENVIRONMENT" "PAYPAL_SANDBOX_URL" "PAYPAL_LIVE_URL" "EUPAGO_ENVIRONMENT" "EUPAGO_SANDBOX_URL" "EUPAGO_LIVE_URL")
