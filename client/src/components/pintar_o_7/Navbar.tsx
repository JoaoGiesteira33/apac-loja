        ...
        <Flowbite theme={{ theme: customTheme }}>
            <FlowbiteNavbar className="" fluid>
                ...
                <FlowbiteNavbar.Collapse>
                    <FlowbiteNavbar.Link href="/gallery" className={window.location.pathname=="/gallery" ? "font-bold text-black" : ""}>a galeria</FlowbiteNavbar.Link>
                    <FlowbiteNavbar.Link href="/artists" className={window.location.pathname=="/artists" ? "font-bold text-black" : ""}>artistas</FlowbiteNavbar.Link>
                    <FlowbiteNavbar.Link href="/contact" className={window.location.pathname=="/contact" ? "font-bold text-black" : ""}>contacto</FlowbiteNavbar.Link>
                    <FlowbiteNavbar.Link href="/login" className={window.location.pathname=="/login" ? "font-bold text-black" : ""}>login</FlowbiteNavbar.Link>
                </FlowbiteNavbar.Collapse>
            </FlowbiteNavbar>
        </Flowbite>
    );
